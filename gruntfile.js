...
//			temp_dist_to_dist_files	=	{ expand: true,	cwd: 'temp_dist',	dest: 'dist'			},	//temp_dist/**/*.* => dist/**/*.*
    ...
    concat: {
	  ...
	  jshint: {
		...
		svgextend: {
			"4x3": {
				options: {requirePng: false },
				inputDir	: 'src/images/_flags/4x3/',
				outputDir	: 'src/',
				outputName: '_lang-flag-4x3',
				outputType: 'placeholder'
			},
			"1x1": {
				options: {requirePng: false },
				inputDir	: 'src/images/_flags/1x1/',
				outputDir	: 'src/',
				outputName: '_lang-flag-1x1',
				outputType: 'placeholder'
			}
	...
	grunt.loadNpmTasks('grunt-svg-extend'); //NEW
